...
import cn.njh.core.exception.NoSuchAxisException;
import cn.njh.core.exception.NoSuchFunctionException;
import cn.njh.core.exception.XpathSyntaxErrorException;
 ...
 * Date: 2017-08-22
 */
public class JXDoucment {
    private Elements elements;
    private XpathEvaluator xpathEva = new XpathEvaluator();
    public JXDoucment(Document doc){
        elements = doc.children();
    }
    public JXDoucment(String html){
        elements = Jsoup.parse(html).children();
    }
    public JXDoucment(Elements els){
        elements = els;
    }
